import { c as createAstro, a as createComponent, b as renderTemplate, f as addAttribute, r as renderComponent, d as renderSlot, m as maybeRenderHead, s as spreadAttributes, g as renderScript, t as renderHead } from './astro/server_JhCfhjtA.mjs';
import 'kleur/colors';
/* empty css                          */
import 'clsx';
  ...
  const footerLinks = [
    {
      title: "Solutions",
      items: [
        { text: "My Documentations", href: "/docs" }
        // { text: "Analytics", href: "#" },
...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">${renderComponent($$result, "Head", $$Head, { "title": title, "description": description })}${renderHead()}</head> <body> <div class="wrapper"> <header class="mb-4"> <div class="container mx-auto"> ${renderComponent($$result, "Navbar", $$Navbar, {})} <hr class="mt-2 border-gray-200"> </div> </header> ${renderScript($$result, "/home/matsu/Desktop/jy/src/layouts/BaseLayout.astro?astro&type=script&index=0&lang.ts")} ${renderSlot($$result, $$slots["default"])} <!-- new footer component  --> ${renderComponent($$result, "Footer", $$Footer, {})} </div> </body></html>`;
}, "/home/matsu/Desktop/jy/src/layouts/BaseLayout.astro", void 0);

export { $$Button as $, SITE_TITLE as S, $$BaseLayout as a, SITE_DESCRIPTION as b };
