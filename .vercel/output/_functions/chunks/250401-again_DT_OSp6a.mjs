...
var _a, _b;
const $$250401Again = createComponent(($$result, $$props, $$slots) => {
...
<\/script>`])), renderComponent($$result, "BaseLayout", $$BaseLayout, {}, { "default": ($$result2) => renderTemplate(_a || (_a = __template([" ", '<main class="container mx-auto"> <h1>Flow Arrow</h1> <!-- p5.js core library --> <script src="https://cdnjs.cloudflare.com/ajax/libs/p5.js/1.6.0/p5.js"><\/script> <!-- p5.js DOM library (for createButton, etc.) --> <script src="https://cdnjs.cloudflare.com/ajax/libs/p5.js/1.6.0/addons/p5.dom.min.js"><\/script> <!-- dat.GUI library --> <script src="https://cdnjs.cloudflare.com/ajax/libs/dat-gui/0.7.9/dat.gui.min.js"><\/script> <!-- p5.svg library --> <script src="https://cdn.jsdelivr.net/npm/p5.js-svg@1.5.1/dist/p5.svg.min.js"><\/script> <!-- Your sketch file --> <div id="p5js-canvas"></div> </main> '])), maybeRenderHead()) }));
}, "/home/matsu/Desktop/jy/src/pages/sketches/250401-again.astro", void 0);

const $$file = "/home/matsu/Desktop/jy/src/pages/sketches/250401-again.astro";
const $$url = "/sketches/250401-again";
