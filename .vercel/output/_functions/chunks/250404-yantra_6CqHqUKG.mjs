...
var _a;
const $$250404Yantra = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Generative Mystical Diagram" }, { "default": ($$result2) => renderTemplate(_a || (_a = __template([' <script src="https://cdnjs.cloudflare.com/ajax/libs/p5.js/1.6.0/p5.min.js"><\/script> <script src="https://unpkg.com/p5.js-svg@1.5.1/dist/p5.svg.js"><\/script> <script src="https://cdnjs.cloudflare.com/ajax/libs/dat-gui/0.7.9/dat.gui.min.js"><\/script> <style>\n      canvas {\n        display: block;\n        margin: 0 auto;\n      }\n      .dg.main .close-button {\n        /* Keep GUI visible */\n        display: none;\n      }\n      /* body {\n        margin: 0;\n        padding: 0;\n        overflow: hidden;\n      } */\n      #json-container {\n        position: fixed;\n        bottom: 10px;\n        right: 10px;\n        background: rgba(0, 0, 0, 0.7);\n        padding: 10px;\n        border-radius: 5px;\n        z-index: 1000;\n        display: none;\n      }\n      #parameters-json {\n        width: 400px;\n        height: 300px;\n        background: #111;\n        color: #eee;\n        border: 1px solid #333;\n        padding: 5px;\n        font-family: monospace;\n        font-size: 11px;\n      }\n      .json-buttons {\n        margin-top: 5px;\n        display: flex;\n        justify-content: space-between;\n      }\n      .json-buttons button {\n        background: #333;\n        color: #fff;\n        border: none;\n        padding: 5px 10px;\n        border-radius: 3px;\n        cursor: pointer;\n      }\n      .json-buttons button:hover {\n        background: #555;\n      }\n    </style> ', `<main> <div id="canvas"></div> </main> <div id="json-container"> <textarea id="parameters-json"></textarea> <div class="json-buttons"> <button id="copy-json">Copy to Clipboard</button> <button id="apply-json">Apply JSON</button> <button id="close-json">Close</button> </div> </div> <script>
      let gui;
      let globalParams = {
      ...
      function setup() {
        ...
        }, "randomizeAll").name("\u{1F3B2} Randomize All");
      ...
      function addLayerGui(guiInstance, params, layerIndex) {
        ...
        }, 'randomize').name('\u{1F3B2} Randomize Layer');
    ...
    <\/script> `], [' <script src="https://cdnjs.cloudflare.com/ajax/libs/p5.js/1.6.0/p5.min.js"><\/script> <script src="https://unpkg.com/p5.js-svg@1.5.1/dist/p5.svg.js"><\/script> <script src="https://cdnjs.cloudflare.com/ajax/libs/dat-gui/0.7.9/dat.gui.min.js"><\/script> <style>\n      canvas {\n        display: block;\n        margin: 0 auto;\n      }\n      .dg.main .close-button {\n        /* Keep GUI visible */\n        display: none;\n      }\n      /* body {\n        margin: 0;\n        padding: 0;\n        overflow: hidden;\n      } */\n      #json-container {\n        position: fixed;\n        bottom: 10px;\n        right: 10px;\n        background: rgba(0, 0, 0, 0.7);\n        padding: 10px;\n        border-radius: 5px;\n        z-index: 1000;\n        display: none;\n      }\n      #parameters-json {\n        width: 400px;\n        height: 300px;\n        background: #111;\n        color: #eee;\n        border: 1px solid #333;\n        padding: 5px;\n        font-family: monospace;\n        font-size: 11px;\n      }\n      .json-buttons {\n        margin-top: 5px;\n        display: flex;\n        justify-content: space-between;\n      }\n      .json-buttons button {\n        background: #333;\n        color: #fff;\n        border: none;\n        padding: 5px 10px;\n        border-radius: 3px;\n        cursor: pointer;\n      }\n      .json-buttons button:hover {\n        background: #555;\n      }\n    </style> ', `<main> <div id="canvas"></div> </main> <div id="json-container"> <textarea id="parameters-json"></textarea> <div class="json-buttons"> <button id="copy-json">Copy to Clipboard</button> <button id="apply-json">Apply JSON</button> <button id="close-json">Close</button> </div> </div> <script>
      let gui;
      let globalParams = {
        seed: Math.floor(Math.random() * 10000),
        regenerate: function () {
...

{
 ...
 -->`;
}, "/home/matsu/Desktop/jy/src/pages/sketches/250404-yantra.astro", void 0);

const $$file = "/home/matsu/Desktop/jy/src/pages/sketches/250404-yantra.astro";
const $$url = "/sketches/250404-yantra";

const __vite_glob_0_25 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$250404Yantra,
  file: $$file,
  url: $$url
